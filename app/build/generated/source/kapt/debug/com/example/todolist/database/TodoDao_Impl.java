...
public final class TodoDao_Impl implements TodoDao {
  ...
  public TodoDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTodo = new EntityInsertionAdapter<Todo>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `todo_table` (`id`,`title`,`note`,`date`) VALUES (?,?,?,?)";
      }
    ...
    this.__preparedStmtOfUpdate = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE todo_table set title = ?, note = ? where id = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object update(final Integer id, final String title, final String note,
      ...
      public List<Todo> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new Todo(_tmpId,_tmpTitle,_tmpNote,_tmpDate);
            _result.add(_item);
          }
          return _result;
        } finally {
